...
public class SceneLoader : MonoBehaviour
{
	...
	[SerializeField] private LoadEventChannelSO _coldStartupLevel = default;
	...
	{
		//EvtLoadLocation.Regist(OnEvtLoadLocation);
	...
	{
		//EvtLoadLocation.Unregist(OnEvtLoadLocation);
		_loadLevel.OnLoadingRequested -= LoadLocation;
		_loadMenu.OnLoadingRequested -= LoadMenu;
#if UNITY_EDITOR
		_coldStartupLevel.OnLoadingRequested -= LocationColdStartup;
	...
	//private void OnEvtLoadLocation(Events obj)
	//{
	//	EvtLoadLocation evt = (EvtLoadLocation)obj;
	//	LoadLocation(evt.locationToLoad, evt.showLoadingScreen, evt.fadeScreen);
	//}
