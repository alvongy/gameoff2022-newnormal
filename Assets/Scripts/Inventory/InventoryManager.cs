...
public class InventoryManager : MonoBehaviour
{
	...
	[Header("Listening on Items Quest")]
	[SerializeField] private IntEventChannelSO OnFindItemsSO;
	...
	void PickItem()
	{
		...
		{
			_onObjectPickUp.RaiseEvent(TestItem);
		}
	}
	...
	//	_cookRecipeEvent.OnEventRaised += CookRecipeEventRaised;
		...
		_onObjectPickUp.OnEventRaised += AddItem;
	...
	{
		_currentInventory.Add(item);
		OnFindItemsSO.RaiseEvent(item.ItemID);
	...
	private void FindItemsSO(int id)
    {
